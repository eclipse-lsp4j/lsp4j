...
- [ ] Tag the release. Example: `git tag -a v0.23.1 HEAD -m"LSP4J 0.23.1" && git push origin v0.23.1`
...
- [ ] Make an announcement on lsp4j-dev based on the [release page on github](https://github.com/eclipse-lsp4j/lsp4j/releases/tag/v0.23.1). [Example on lsp4j-dev archives](https://www.eclipse.org/lists/lsp4j-dev/msg00063.html)
