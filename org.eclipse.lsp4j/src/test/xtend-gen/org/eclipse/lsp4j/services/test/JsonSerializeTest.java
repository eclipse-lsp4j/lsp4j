...
public class JsonSerializeTest {
  ...
  public void setup() {
    ...
    GsonBuilder _defaultGsonBuilder = MessageJsonHandler.getDefaultGsonBuilder();
    final GsonBuilder gsonBuilder = _defaultGsonBuilder.setPrettyPrinting();
    Gson _create = gsonBuilder.create();
    MessageJsonHandler _messageJsonHandler = new MessageJsonHandler(_create, methods);
  ...
  public void testRename() {
    ...
    StringConcatenation _builder = new StringConcatenation();
    _builder.append("{\"id\":12,\"jsonrpc\":2.0,\"result\":{");
    _builder.newLine();
    _builder.append("  ");
  ...
  public void testResponseError() {
    ...
    final ResponseMessage message = ObjectExtensions.<ResponseMessage>operator_doubleArrow(_responseMessage, _function);
    StringConcatenation _builder = new StringConcatenation();
    _builder.append("{\"id\":12,\"jsonrpc\":2.0,\"error\":{");
    _builder.newLine();
    _builder.append("  ");
