pipeline {
  ...
  parameters {
    ...
    string(defaultValue: 'updates/milestones/S201911261515', description: 'The relative path in LSP4J downloads area to publish promoted build to (e.g. updates/milestones/S201911261515, updates/releases/0.21.0)', name: 'LSP4J_PUBLISH_LOCATION')
    string(defaultValue: 'lsp4j-multi-build/job/main', description: 'The LSP4J project name being promoted from (e.g. lsp4j-multi-build/job/main or lsp4j-multi-build/job/release_0.21.0).', name: 'PROJECT')
