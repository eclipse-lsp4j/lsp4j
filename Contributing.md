...
3. Import the root of LSP4J as a Gradle project:
    ...
    3. Select the root of the cloned directory as "Project root directory"
    4. Finish the wizard - this will import all the projects but there will be lots of errors
...
6. Clean the projects
    ...
    2. Select all the lsp4j projects
